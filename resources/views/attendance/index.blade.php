...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
  ...
  <div class="dropdown">
    <button class="dropbtn">Check Attendance</button>
    <div class="dropdown-content">
      <a href="monthlyatd">Choose Month</a>
  ...
  <table id="datatb" class="table table-striped table-hover table-responsive">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{$attendanceDetail->regno}}</td>
            <td>{{$attendanceDetail->name}}</td>
            <td>{{$attendanceDetail->subject}}</td>
            <td>{{$attendanceDetail->month}}</td>
            <td>{{$attendanceDetail->date}}</td>
            <td>{{$attendanceDetail->status}}</td>


                 <td> <a href="{{ route('attendance.show', $attendanceDetail->id)}}" class="btn btn-success">Show</a></td>
           <td> <a href="{{ route('attendance.edit', $attendanceDetail->id)}}" class="btn btn-primary">Edit</a></td>

            <td>   <form action="{{ route('attendance.destroy', $attendanceDetail->id)}}" method="post">
                  @csrf
                  @method('DELETE')
